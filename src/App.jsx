  ...
  function App() {
    ...
    return (
      <>
        <div>
  <header >
  {/* <img src={topi} alt="topi vappa icon" className="h-24" /> */}
    <h1 className="text-xl font-bold  text-black ml-2">
      ...
      <div >
        <a href='https://wa.me/${+917305748889}'>
  ...
  <div className="flex m-2 ">
    ...
    <img src={nonveg}  alt="non veg" className=" ml-2 w-8 h-auto " />
  </div>
  <div className="ml-2 ">
    <ul>
  ...
  <div className="flex items-center ml-2">
      ...
      <img src={veg} alt=" veg" className="w-8 h-auto ml-2" />
    </div>
    <div className='ml-2'>
    <ul>
  ...
  <div className="flex items-center ml-2">
      ...
      <img src={veg} alt="non veg" className="w-8 h-auto ml-2" />
    </div>
    <div className="flex items-center ml-2">
      <h4 className='text-sm font-bold'>[FOR SCHEZWAN RS 10 EXTRA]</h4>  
    </div>
  ...
  <div className="flex items-center ml-2">
      ...
      <img src={nonveg}  alt="non veg" className="w-8 h-auto ml-2" />
    </div>  
  ...
  <div className="flex items-center ml-2">
    ...
    <li className="flex flex-col">
      ...
      <div className="flex justify-between mr-2">
        <p>Family Kebab Platter(5 flavours)</p>
        <p>₹699</p>
      </div>
      <div className="flex justify-between mr-2">
        <p>Tandoori Fish</p>
  ...
  <div className="flex items-center ml-2">
      ...
      <img src={nonveg} alt="non veg" className="w-8 h-auto mr-2 " />
    </div>  
